...
public class EnergySchedulingComponent {
    ...
    public int getMutationPower(Seed currentSeed) {
        int baseEnergy = 3; // 基础能量值，最低变异次数
        int energy = baseEnergy;
        int previousCoverage = currentSeed.getPreviousCoverage();
        ...
        // 基于覆盖率增量调整能量
        energy += (int) (coverageIncrementRatio * 3); // 增量比例每提升 3%，增加 1 次变异
